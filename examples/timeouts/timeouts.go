// _Timeouts_ là rất quan trọng đối với các chương trình kết nối
// đến tài nguyên bên ngoài hoặc cần giới hạn thời gian thực thi.
// Việc triển khai timeouts trong Go rất dễ dàng và hiệu quả nhờ vào
// channels và `select`.
